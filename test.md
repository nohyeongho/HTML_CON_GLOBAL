<html lang="ko" style="height: 100%;"><head>
    ...
    <title>HTML 변환기</title>
    <!-- Use FontAwesome for simple icons -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <!-- Use Marked.js for Markdown parsing (Specific version for stability) -->
    <script src="https://cdn.jsdelivr.net/npm/marked@4.3.0/marked.min.js"></script>
    <!-- html2canvas for preview-to-image copy -->
    ...
    <style type="text/css">
        ...
        .content-service-view .lg-red {
            color: #ec455a !important;
        }

        .content-service-view .c-gray {
            color: #999 !important;
        }

        .content-service-view strong {
            font-weight: 600;
        }
        ...
        .content-service-view ul {
            margin: 0 0 20px;
            padding: 0;
            list-style: none;
        }

        .content-service-view [class^="iframe-wrap"] {
            margin-top: 15px;
        }

        .content-service-view .iframe-wrap iframe {
            width: 640px;
        }

        .content-service-view .iframe-wrap-shorts iframe {
            width: 365px;
        }
        ...
        .content-service-view .tit:before {
            content: "";
            overflow: hidden;
            position: absolute;
            left: 0;
        ...
        .content-service-view .tit:first-child {
            margin-top: 0;
        }

        .content-service-view .info-subject+.tit {
            margin-top: 40px;
        }
        ...
        .content-service-view .sub-tit:before {
            content: "";
            overflow: hidden;
            position: absolute;
            left: 0;
            ...
            height: 18px;
            border-radius: 50%;
            background: #999 url(https://gscs.lge.com:/gscs/support/fileupload/downloadFile.do?fileId=CYfUaCPKDZkbFewB3OjoAA&portalId=P1) no-repeat 4px 50%;
            background-size: 10px;
        }

        .content-service-view .sub-tit:first-child,
        .content-service-view .tit+.sub-tit {
            margin-top: 20px;
        }

        .content-service-view .sub-tit .num {
            display: block;
            position: absolute;
            left: 0;
            top: 5px;
        ...
        .content-service-view .info-tit {
            margin: 20px 0 0;
            padding-left: 20px;
            font-size: 15px;
            font-weight: 500;
            color: #000;
            background: url(https://gscs.lge.com:/gscs/support/fileupload/downloadFile.do?fileId=81CJtgOoS8EBzjcpk4oCvA&portalId=P1) no-repeat 0 5px;
        ...
        .content-service-view .info-desc.idt {
            margin-left: 18px;
            text-indent: -18px;
        }

        .content-service-view .txt-idt {
        ...
        .content-service-view .img-only img:last-child {
            margin-bottom: 0;
        }
        ...
        .content-service-view .img-box a {
            font-size: 0;
            line-height: 0;
        }
        ...
        .content-service-view .cause-list li:before {
            content: "";
            position: absolute;
            left: 0;
            top: 9px;
        ...
        .content-service-view .bul-list li:before {
            content: "";
            position: absolute;
            left: 0;
            top: 9px;
        ...
        .content-service-view .tbl-scroll table {
        ...
        @media screen and (max-width: 768px) {
            .content-service-view .tbl-scroll table[style*="width: 600px"] {
                width: 100% !important;
            }
        }
        ...
        .content-service-view .tbl-scroll td p {
            margin-bottom: 0;
        }

        .content-service-view .tbl-scroll .bg-red td {
            background-color: rgba(236, 69, 90, 0.06);
        }

        /* Converter Application Styles */
        body {
        ...
        .editor-content-view:empty:before {
        ...
        .btn-add-section {
            ...
            color: var(--lg-mid-gray);
            border: 1px dashed var(--lg-mid-gray);
            border-radius: var(--radius-md);
            cursor: pointer;
            margin-bottom: 25px;
            font-weight: 600;
        ...
        .mobile-tabs button.active {
            color: var(--lg-red);
            border-bottom-color: var(--lg-red);
        }
        ...
        /* Modal Styles for Visual Table Editor */
        .modal {
            display: none;
            position: fixed;
            z-index: 1000;
...
<link type="text/css" rel="stylesheet" charset="UTF-8" href="https://www.gstatic.com/_/translate_http/_/ss/k=translate_http.tr.2f3WBw8L4SI.L.W.O/am=AAAO/d=0/rs=AN8SPfqEMEisTZAmeZOnTrf_mfOPDE49Nw/m=el_main_css"><script type="text/javascript" charset="UTF-8" src="https://translate.googleapis.com/_/translate_http/_/js/k=translate_http.tr.ko.zNzct8iCnHU.O/am=AABA/d=1/exm=el_conf/ed=1/rs=AN8SPfrkMeHA5znnJFzOvYySuC3JicZKwA/m=el_main"></script></head>
...
<body style="position: relative; min-height: 100%; top: 0px;">
    ...
    <div class="app-container">
        <!-- Hidden Data Container for Product Selection -->
        <div class="postData" style="display:none;" data-productlv2="['ALL']" data-productlv3="['ALL']"></div>

        <!-- Input Panel -->
        <div class="input-panel active notranslate" id="inputPanel">
            <h2 class="panel-title">
                <span>Qbot HTML 변환기 / 정보 입력 (마크다운 지원)</span>
                <span style="font-size: 11px; color: #999; font-weight: normal;">Created by n.y.h</span>
            </h2>
            <p style="font-size: 12px; color: #666; margin-bottom: 20px;">
                <b>팁</b>: 이미지를 붙여넣거나(Ctrl+V), 엑셀 표를 복사해서 붙여넣어도 자동으로 변환됩니다.<br>
                표 작성방법 : 엑셀 표를 복사해서 붙여넣기를 하거나, 표 입력창을 선택하여 직접 내용을 작성해도 됩니다.
            </p>

            <div style="margin-bottom: 20px; border-bottom: 2px solid var(--lg-red); padding-bottom: 10px;">
                <h3 style="color: var(--lg-red); margin: 0; font-size: 18px;">필수정보 입력</h3>
            </div>
            <div class="form-group">
                <label>제목</label>
                <input type="text" id="inTitle" placeholder="예: 드럼 세탁기 LE9 에러 발생 시 조치방법">
            </div>
            ...
            <div class="form-group">
                ...
                <div style="display: flex; gap: 10px;">
                    <div class="input-wrap">
                        <input type="text" id="inProductFamily" placeholder="예: 세탁기 (선택 버튼을 사용하세요)" readonly="" style="background-color: #f9f9f9; cursor: pointer; padding-right: 35px;" onclick="openProductModal()" oninput="toggleClearBtn('inProductFamily', 'clearProduct')">
                        <div id="clearProduct" class="clear-btn" onclick="clearProductFamily()">×</div>
                    </div>
                    <button class="btn-secondary" onclick="openProductModal()" style="width: 80px;">선택</button>
                </div>
            </div>

            <div class="form-group">
                <label>적용 모델 <span style="font-size: 12px; color: #666; font-weight: normal; margin-left: 10px;">(*수동으로
                        모델명을 입력할 경우 모델명 사이 반드시 ","을 사용하여 구분하세요.)</span></label>
                <div style="display: flex; gap: 10px;">
                    <div class="input-wrap">
                        <input type="text" id="inAppliedModel" placeholder="예: FX23/FX24/FX25 시리즈" oninput="syncModelData(); toggleClearBtn('inAppliedModel', 'clearModel')" onblur="validateModelInput()" style="padding-right: 35px;">
                        <div id="clearModel" class="clear-btn" onclick="clearAppliedModel()">×</div>
                    </div>
                    <button class="btn-secondary" onclick="openModelModal()" style="width: 80px;">선택</button>
                </div>
            </div>

            <div class="form-group">
                <label>대상 제번</label>
                <input type="text" id="inTargetSerial" placeholder="예: ALL">
            </div>

            <div class="form-group">
                <label>조치 방법 (요약)</label>
            ...
            <button onclick="openTableModal(event)" onmousedown="event.preventDefault()"><i class="fas fa-table"></i></button>
                    ...
                    <div id="inActionSummary" class="editor-content-view paste-area" contenteditable="true" placeholder="예: LQC 모드 진입 시에만 발생되며, 에러 발생 시 메인 PCB 교체 안내"></div>
                </div>
            </div>

            <!-- Pre-defined sections -->
            <div style="margin-top: 30px; margin-bottom: 20px; border-bottom: 2px solid var(--lg-red); padding-bottom: 10px;">
                <h3 style="color: var(--lg-red); margin: 0; font-size: 18px;">내용 입력 <span style="font-size: 12px; color: #666; font-weight: normal; margin-left: 10px;">(TEXT 형태의 내용위주로
                        저연차도 너무 쉽게 이해할수 있도록 작성해주세요. 이미지와 표는 참고용으로만 작성해주세요)</span></h3>
            </div>
            <div class="form-group">
                <label>1. 증상 <span style="font-size: 12px; color: #666; font-weight: normal; margin-left: 10px;">(제목 수정
                        가능_아래항목에 제목만 입력하세요. 번호는 자동부여됩니다.)</span></label>
                <div style="display:flex; gap:10px; margin-bottom:5px;">
                    <input type="text" id="inSymptomTitle" value="증상" style="flex:1;">
                </div>
                <div class="editor-container">
                    <div class="editor-toolbar">
            <select onchange="changeFontFamily(this)" class="font-family-select" onmousedown="event.stopPropagation()">
            ...
            <button onclick="openTableModal(event)" onmousedown="event.preventDefault()"><i class="fas fa-table"></i></button>
                    ...
                    <div id="inSymptom" class="editor-content-view paste-area" contenteditable="true" placeholder="예: - LE9 에러 발생"></div>
                </div>
            </div>

            <div class="form-group">
                <label>2. 불량 원인 <span style="font-size: 12px; color: #666; font-weight: normal; margin-left: 10px;">(제목
                        수정 가능_아래항목에 제목만 입력하세요. 번호는 자동부여됩니다.)</span></label>
                <div style="display:flex; gap:10px; margin-bottom:5px;">
                    <input type="text" id="inCauseTitle" value="불량 원인" style="flex:1;">
                </div>
                <div class="editor-container">
                    <div class="editor-toolbar">
            <select onchange="changeFontFamily(this)" class="font-family-select" onmousedown="event.stopPropagation()">
            ...
            <button onclick="openTableModal(event)" onmousedown="event.preventDefault()"><i class="fas fa-table"></i></button>
                    ...
                    <div id="inCause" class="editor-content-view paste-area" contenteditable="true" placeholder="예: - 메인 PCB 불량"></div>
                </div>
            </div>

            <div class="form-group">
                <label>3. 수리 방법 <span style="font-size: 12px; color: #666; font-weight: normal; margin-left: 10px;">(제목
                        수정 가능_아래항목에 제목만 입력하세요. 번호는 자동부여됩니다.)</span></label>
                <div style="display:flex; gap:10px; margin-bottom:5px;">
                    <input type="text" id="inRepairTitle" value="서비스 방법" style="flex:1;">
                </div>
                <div class="editor-container">
                    <div class="editor-toolbar">
            <select onchange="changeFontFamily(this)" class="font-family-select" onmousedown="event.stopPropagation()">
            ...
            <button onclick="openTableModal(event)" onmousedown="event.preventDefault()"><i class="fas fa-table"></i></button>
                    ...
                    <div id="inRepairMethod" class="editor-content-view paste-area" contenteditable="true" placeholder="예: - LQC 모드 진입 시에만 발생되며, 에러 발생 시 메인 PCB 교체 안내"></div>
                </div>
            </div>
            ...
            <button class="btn-add-section" onclick="addDynamicSection()">+ 섹션 추가</button>

            <button class="btn-convert" onclick="generateHTML()">HTML 변환 생성</button>
        </div>

        <!-- Preview Panel -->
        <div class="preview-panel" id="previewPanel">
            <h2 class="panel-title notranslate">
                <div style="display: flex; align-items: center; gap: 10px;">
                    <i class="fas fa-language" style="color: #666; font-size: 18px;"></i>
                    <span>기기 미리보기</span>
                    <div id="google_translate_element" style="border-width: medium; border-style: none; border-color: currentcolor; border-image: initial; background-color: transparent; min-width: auto;">번역기 불러오는 중...<div class="skiptranslate goog-te-gadget" dir="ltr" style=""><div id=":0.targetLanguage" class="goog-te-gadget-simple" style="white-space: nowrap;"><img src="https://www.google.com/images/cleardot.gif" class="goog-te-gadget-icon" alt="" style="background-image: url(&quot;https://translate.googleapis.com/translate_static/img/te_ctrl3.gif&quot;); background-position: -65px 0px;"><span style="vertical-align: middle;"><a aria-haspopup="true" class="VIpgJd-ZVi9od-xl07Ob-lTBxed" href="#"><span>언어 선택</span><img src="https://www.google.com/images/cleardot.gif" alt="" width="1" height="1"><span style="border-left: 1px solid rgb(187, 187, 187);">​</span><img src="https://www.google.com/images/cleardot.gif" alt="" width="1" height="1"><span aria-hidden="true" style="color: rgb(118, 118, 118);">▼</span></a></span></div></div></div>
                </div>
                <button id="btnCopyPreview" onclick="copyPreview()" title="미리보기 내용을 이미지로 복사하여 PPT에 붙여넣기" style="font-size: 13px; font-weight: 600; padding: 6px 14px; background: #4caf50; color: white; border: none; border-radius: 6px; cursor: pointer; display: none; margin-left: auto; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'">📋 미리보기 복사
                    (PPT용)</button>
            </h2>
            <div class="preview-frame" id="previewContainer">
                <div style="padding: 40px; text-align: center; color: #999;">
                    <i class="fas fa-magic" style="font-size: 48px; margin-bottom: 20px; display: block;"></i>
                    내용을 입력하고 <b>HTML 변환</b> 버튼을 누르세요.
                </div>
            </div>

            <div class="code-area notranslate">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                    <h3 style="font-size: 16px; margin: 0;">HTML 소스 코드</h3>
                    <div style="display: flex; gap: 8px;">
                        <button class="btn-primary" onclick="copyCode()" style="padding: 5px 15px; font-size: 13px;">복사</button>
                    </div>
                </div>
                <textarea id="codeOutput" class="notranslate" placeholder="변환된 코드가 이곳에 표시됩니다..." readonly=""></textarea>
            </div>
        </div>
    </div>

    <!-- Table Editor Modal -->
    <div id="tableModal" class="modal notranslate">
        <div class="modal-content">
            <span class="close-modal" onclick="closeTableModal()">×</span>
            <h2 style="margin-top: 0; border-bottom: 2px solid var(--lg-red); padding-bottom: 12px; margin-bottom: 20px; font-size: 24px;">
                표 삽입 <span style="font-size: 14px; color: #666; font-weight: normal; margin-left: 10px;">아래표에 직접
                    입력하세요</span></h2>
            <div class="table-controls">
                <label>행(Row): <input type="number" id="tblRows" value="3" min="1" style="width: 50px; border:1px solid #ccc;"></label>
                <label>열(Col): <input type="number" id="tblCols" value="2" min="1" style="width: 50px; border:1px solid #ccc;"></label>
                <button class="btn-secondary" onclick="generateVisualTable()">표 생성/초기화</button>
                <span style="font-size:12px; color:#999; margin-left:8px;">💡 셀 테두리를 드래그하면 크기를 조절할 수 있습니다</span>
            </div>
            <div id="visualTableContainer" style="overflow-x:auto; max-height:400px; overflow-y:auto;">
                <!-- Visual Table will be generated here -->
            </div>
            <div style="text-align: right; margin-top: 20px;">
                <button class="btn-secondary" onclick="closeTableModal()">취소</button>
                <button class="btn-primary" onclick="insertTableFromModal()">본문에 삽입</button>
            </div>
        </div>
    </div>
    ...
    <div id="customColorPicker" class="color-picker-popup" onmousedown="event.preventDefault()">
        ...
        <div id="themeColorsGrid" class="cp-grid"><div class="cp-cell" style="background-color: rgb(255, 255, 255);"></div><div class="cp-cell" style="background-color: rgb(0, 0, 0);"></div><div class="cp-cell" style="background-color: rgb(238, 236, 225);"></div><div class="cp-cell" style="background-color: rgb(31, 73, 125);"></div><div class="cp-cell" style="background-color: rgb(79, 129, 189);"></div><div class="cp-cell" style="background-color: rgb(192, 80, 77);"></div><div class="cp-cell" style="background-color: rgb(155, 187, 89);"></div><div class="cp-cell" style="background-color: rgb(128, 100, 162);"></div><div class="cp-cell" style="background-color: rgb(75, 172, 198);"></div><div class="cp-cell" style="background-color: rgb(247, 150, 70);"></div><div class="cp-cell" style="background-color: rgb(242, 242, 242);"></div><div class="cp-cell" style="background-color: rgb(127, 127, 127);"></div><div class="cp-cell" style="background-color: rgb(221, 217, 195);"></div><div class="cp-cell" style="background-color: rgb(198, 217, 240);"></div><div class="cp-cell" style="background-color: rgb(219, 229, 241);"></div><div class="cp-cell" style="background-color: rgb(242, 220, 219);"></div><div class="cp-cell" style="background-color: rgb(235, 241, 222);"></div><div class="cp-cell" style="background-color: rgb(229, 224, 236);"></div><div class="cp-cell" style="background-color: rgb(219, 238, 243);"></div><div class="cp-cell" style="background-color: rgb(253, 234, 218);"></div><div class="cp-cell" style="background-color: rgb(216, 216, 216);"></div><div class="cp-cell" style="background-color: rgb(89, 89, 89);"></div><div class="cp-cell" style="background-color: rgb(196, 189, 151);"></div><div class="cp-cell" style="background-color: rgb(141, 179, 226);"></div><div class="cp-cell" style="background-color: rgb(184, 204, 228);"></div><div class="cp-cell" style="background-color: rgb(229, 185, 183);"></div><div class="cp-cell" style="background-color: rgb(215, 227, 188);"></div><div class="cp-cell" style="background-color: rgb(204, 193, 217);"></div><div class="cp-cell" style="background-color: rgb(183, 221, 232);"></div><div class="cp-cell" style="background-color: rgb(251, 213, 181);"></div><div class="cp-cell" style="background-color: rgb(191, 191, 191);"></div><div class="cp-cell" style="background-color: rgb(63, 63, 63);"></div><div class="cp-cell" style="background-color: rgb(147, 137, 83);"></div><div class="cp-cell" style="background-color: rgb(84, 141, 212);"></div><div class="cp-cell" style="background-color: rgb(149, 179, 215);"></div><div class="cp-cell" style="background-color: rgb(217, 150, 148);"></div><div class="cp-cell" style="background-color: rgb(195, 214, 155);"></div><div class="cp-cell" style="background-color: rgb(178, 162, 199);"></div><div class="cp-cell" style="background-color: rgb(146, 205, 220);"></div><div class="cp-cell" style="background-color: rgb(250, 192, 143);"></div><div class="cp-cell" style="background-color: rgb(165, 165, 165);"></div><div class="cp-cell" style="background-color: rgb(38, 38, 38);"></div><div class="cp-cell" style="background-color: rgb(73, 68, 41);"></div><div class="cp-cell" style="background-color: rgb(23, 54, 93);"></div><div class="cp-cell" style="background-color: rgb(54, 96, 146);"></div><div class="cp-cell" style="background-color: rgb(149, 55, 52);"></div><div class="cp-cell" style="background-color: rgb(118, 146, 60);"></div><div class="cp-cell" style="background-color: rgb(95, 73, 122);"></div><div class="cp-cell" style="background-color: rgb(49, 133, 155);"></div><div class="cp-cell" style="background-color: rgb(227, 108, 9);"></div><div class="cp-cell" style="background-color: rgb(127, 127, 127);"></div><div class="cp-cell" style="background-color: rgb(12, 12, 12);"></div><div class="cp-cell" style="background-color: rgb(29, 27, 16);"></div><div class="cp-cell" style="background-color: rgb(15, 36, 62);"></div><div class="cp-cell" style="background-color: rgb(36, 64, 97);"></div><div class="cp-cell" style="background-color: rgb(99, 36, 35);"></div><div class="cp-cell" style="background-color: rgb(79, 97, 40);"></div><div class="cp-cell" style="background-color: rgb(63, 49, 81);"></div><div class="cp-cell" style="background-color: rgb(32, 88, 103);"></div><div class="cp-cell" style="background-color: rgb(151, 72, 6);"></div></div>
        <div class="cp-section-title">표준 색상</div>
        <div id="standardColorsRow" class="cp-grid"><div class="cp-cell" style="background-color: rgb(192, 0, 0);"></div><div class="cp-cell" style="background-color: rgb(255, 0, 0);"></div><div class="cp-cell" style="background-color: rgb(255, 192, 0);"></div><div class="cp-cell" style="background-color: rgb(255, 255, 0);"></div><div class="cp-cell" style="background-color: rgb(146, 208, 80);"></div><div class="cp-cell" style="background-color: rgb(0, 176, 80);"></div><div class="cp-cell" style="background-color: rgb(0, 176, 240);"></div><div class="cp-cell" style="background-color: rgb(0, 112, 192);"></div><div class="cp-cell" style="background-color: rgb(0, 32, 96);"></div><div class="cp-cell" style="background-color: rgb(112, 48, 160);"></div></div>
...
<tbody>${body}</tbody>
        ...
        let edIsRowResizing = false, edIsColResizing = false;
        let edStartX, edStartY, edStartW, edStartH, edStartTableW;
        let edTargetCell = null, edTargetRow = null;
        let edIsPendingColResize = false, edIsPendingRowResize = false;
        ...
        document.querySelectorAll('.paste-area').forEach(el => {
            ...
            el.addEventListener('keyup', saveSelectionState);
        });
        ...
        window.addEventListener('mousemove', function (e) {
            ...
            edMouseTimer = requestAnimationFrame(function () {
                // Threshold check before starting resize
                if (!edIsColResizing && !edIsRowResizing) {
                    if (edIsPendingColResize || edIsPendingRowResize) {
                        ...
                        if (dist > 3) {
                            ...
                            else if (edIsPendingRowResize) edStartRowResize();
                        }
                    }
                }
                // Column resize
                ...
                } else if (edIsRowResizing && edTargetRow) {
                ...
                } else if (!edIsColResizing && !edIsRowResizing) {
                    // Cursor feedback on edges
                    const cell = e.target.closest('.editor-content-view td, .editor-content-view th');
                    if (cell) {
                        const rect = cell.getBoundingClientRect();
                        const isEdgeX = Math.abs(curX - rect.right) < 8 || Math.abs(curX - rect.left) < 8;
                        const isEdgeY = Math.abs(curY - rect.bottom) < 8;
                        cell.style.cursor = isEdgeX ? 'ew-resize' : isEdgeY ? 'ns-resize' : '';
                    }
                }
                edMouseTimer = null;
            });
        ...
        window.addEventListener('mouseup', function () {
            edIsColResizing = false;
            edIsRowResizing = false;
            edIsPendingColResize = false;
            edIsPendingRowResize = false;
            edTargetCell = null;
            edTargetRow = null;
        ...
        function initTableResize() {
            ...
            container.addEventListener('mousedown', function (e) {
                ...
                const rect = cell.getBoundingClientRect();
                const isRight = Math.abs(e.clientX - rect.right) < 8;
                const isLeft = Math.abs(e.clientX - rect.left) < 8;
                const isBottom = Math.abs(e.clientY - rect.bottom) < 8;
                const tbl = cell.closest('table');
                if (!tbl) return;
            ...
            container.addEventListener('mousemove', function (e) {
                    ...
                    if (isPendingTblColResize || isPendingTblRowResize) {
                        ...
                        if (dist > 3) {
                            if (isPendingTblColResize && tblTargetCell) {
                                ...
                                tbl.style.tableLayout = 'fixed';
                                document.body.style.cursor = 'ew-resize';
                            } else if (isPendingTblRowResize && tblTargetRow) {
                ...
                } else if (isTblRowResizing && tblTargetRow) {
                ...
                } else if (!isTblColResizing && !isTblRowResizing) {
        ...
        function handleContentPaste(e) {
            ...
            // 1. 엑셀 형태의 탭 구분 텍스트인 경우 (표 변환 우선)
            if (t && t.indexOf('\t') !== -1) {
                e.preventDefault();
                const lines = t.trim().split(/\r\n|\n|\r/), rows = lines.map(line => line.split('\t')), max = Math.max(...rows.map(r => r.length));
                let tableHtml = `<div class="tbl-scroll">\n<table style="width: auto;" class="xfe_just_info">\n<thead>\n<tr>\n`;
                rows[0].forEach(c => tableHtml += `<th style="padding: 2px 8px; line-height: 1.2;">${c || '&nbsp;'}</th>\n`);
                for (let j = rows[0].length; j < max; j++) tableHtml += `<th style="padding: 2px 8px; line-height: 1.2;">&nbsp;</th>\n`;
                tableHtml += '</tr>\n</thead>\n<tbody>\n';
                for (let i = 1; i < rows.length; i++) {
                    tableHtml += '<tr>\n';
                    rows[i].forEach(c => tableHtml += `<td style="padding: 2px 8px; line-height: 1.2;">${c || '&nbsp;'}</td>\n`);
                    for (let j = rows[i].length; j < max; j++) tableHtml += `<td style="padding: 2px 8px; line-height: 1.2;">&nbsp;</td>\n`;
                    tableHtml += '</tr>\n';
                }
                tableHtml += '</tbody>\n</table>\n</div>\n<p><br></p>\n';
            ...
            // 2. HTML 내용이 있는 경우 (웹페이지, MS 워드/파포 등에서 복사)
            if (h) {
                e.preventDefault();
                const tempDiv = document.createElement('div');
                // DOMPurify나 복잡한 정규식 없이 임시 DOM을 이용하여 필터링
                tempDiv.innerHTML = h;

                // 불필요한 메타, 스타일 태그 제거
                tempDiv.querySelectorAll('meta, style, script, link').forEach(el => el.remove());

                // 모든 요소에서 직접 서식(폰트, 크기)을 완전히 초기화하고 필요한 것만 복원
                tempDiv.querySelectorAll('*').forEach(el => {
                    ...
                    if (el.style) {
                        // 2. 색상 보존 여부 확인 (붉은색 등 포인트 컬러만 남기기)
                        const c = el.style.color ? el.style.color.toLowerCase() : '';
                        const isSpecial = c && !(c.includes('rgb(0, 0, 0)') || c.includes('rgb(34, 34, 34)') || c.includes('rgb(51, 51, 51)') || c.includes('#000000') || c.includes('#000') || c.includes('#333') || c.includes('gray'));

                        // 3. 서식 완전 초기화 (PPT의 지저분한 인라인 스타일/그레이 배경 증발)
                        el.style.cssText = '';

                        // 4. 선별적 복구
                        if (isSpecial) el.style.color = c;
                        ...
                        if (tag === 'img') {
                            ...
                            // 일반 텍스트 요소: 12px 고정 및 자연스러운 줄 간격(1.6) 적용
                            el.style.fontSize = '12px';
                            el.style.backgroundColor = 'transparent';
                            el.style.lineHeight = '1.6';
                            // PPT 등에서 줄 단위로 div가 생기는 경우를 대비해 최소한의 여백 허용
                            if (tag === 'div' || tag === 'p') {
                ...
                // 불필요한 빈 span 태그 전처리 (텍스트만 덜렁 남지 않게 최적화)
            ...
            // 3. 일반 평문 텍스트인 경우 공백 처리 후 삽입 (텍스트 우선 적용)
            ...
            // 4. 파일 형태의 이미지인 경우 (캡처 도구, 탐색기 파일 복사 등)
                ...
                if (item.type.startsWith('image/')) {
                    ...
                    reader.onload = ev => {
                        ...
                        img.onload = () => {
                            ...
                            insertHTML(`<div class="img-only"><img src="${ev.target.result}" width="${w}" style="max-width:100%; height:auto;" class="xfe_just_info"></div><p><br></p>`);
                        };
        ...
        function generateHTML() {
            ...
            function generateSection(title, content) {
                ...
                return `
<h3 class="sub-tit">
<span class="num">${sectionIndex++}</span>${title}</h3>
${content}`;
            }
...
.content-service-view ol,.content-service-view ul{margin:0 0 20px;padding:0;list-style:none}
...
.content-service-view .tbl-scroll table{border-collapse:collapse}
.content-service-view .tbl-scroll td,.content-service-view .tbl-scroll th{padding:7px;border:1px solid #ccc;text-align:center;white-space:nowrap;vertical-align:middle;font-size:14px;line-height:1.6}
.content-service-view .tbl-scroll th{font-size:15px;font-weight:600;background:#ddd}
...
${contentBody}
        ...
        async function copyPreview() {
            ...
            // PPT/Word에서 서식이 유지되도록 핵심 스타일 포함
            const inlineStyles = `<style>
                body { font-family: Arial, sans-serif; font-size: 14px; line-height: 1.6; color: #444; }
                p { margin: 0 0 10px 0; padding: 0; }
                strong { font-weight: 700; }
                ul, ol { margin: 0 0 15px; padding-left: 15px; }
                li { margin-top: 5px; line-height: 1.5; }
                table { border-collapse: collapse; margin: 10px 0; }
                td, th { padding: 7px 10px; border: 1px solid #ccc; text-align: center; font-size: 14px; vertical-align: middle; }
                th { font-weight: 700; background: #ddd; }
                .tit { font-weight: 700; font-size: 20px; color: #444; margin: 20px 0 8px; border-bottom: 2px solid #ec455a; padding-bottom: 5px; }
                .sub-tit { font-size: 16px; font-weight: 600; margin: 15px 0 6px; padding-left: 20px; }
                .sub-tit .num { display: inline-block; width: 18px; height: 18px; line-height: 18px; text-align: center; border-radius: 50%; font-size: 11px; color: #fff; background: #999; margin-left: -20px; margin-right: 4px; }
                .info-subject { font-size: 16px; font-weight: 600; }
                .lg-red, .lg-red * { color: #ec455a !important; }
                .c-gray { color: #999 !important; }
                .tbl-scroll { margin-bottom: 15px; }
            </style>`;

            // 미리보기 HTML에 스타일을 포함한 완전한 HTML 문서 생성
            const htmlContent = `<!DOCTYPE html><html><head><meta charset="utf-8">${inlineStyles}</head><body>${previewEl.innerHTML}</body></html>`;
            const plainText = previewEl.innerText || previewEl.textContent || '';

            try {
                // 방법 1: ClipboardItem API (Chrome 86+, Edge 86+)
                if (navigator.clipboard && window.ClipboardItem) {
                    ...
                    btn.textContent = '✅ 복사 완료! PPT에서 Ctrl+V';
                    setTimeout(() => { btn.textContent = originalText; btn.disabled = false; }, 2500);
                    return;
                }
            } catch (e) {
                console.warn('ClipboardItem API 실패, 폴백 시도:', e);
            }

            // 방법 2: execCommand 폴백 (구형 브라우저 / file:// 환경)
            try {
                const tempDiv = document.createElement('div');
                ...
                alert('자동 복사에 실패했습니다.\n\n대안: 미리보기 영역을 마우스로 전체 선택(Ctrl+A) 후 복사(Ctrl+C) 해보세요.');
        ...
        function googleTranslateElementInit() {
            ...
            try {
                ...
                // 번역에 의한 변화 감지 및 자동 소스 코드 업데이트 (MutationObserver)
...
.content-service-view .sub-tit .num{display:block;position:absolute;left:0;top:5px;width:17px;height:17px;text-align:center;border-radius:50%;font-size:11px;color:#fff;background:#999}
.content-service-view .tbl-scroll{position:relative;overflow-x:auto;margin:0 0 15px}
.content-service-view .tbl-scroll table{border-collapse:collapse; width: 600px;}
.content-service-view .tbl-scroll td,.content-service-view .tbl-scroll th{padding:7px;border:1px solid #ccc;text-align:center;vertical-align:middle;font-size:14px;line-height:1.6}
.content-service-view .tbl-scroll th{font-size:15px;font-weight:600;background:#ddd}
</style>
</head>
<body>
...
${contentBody}
    ...
    <!-- Product Family Selector Modal -->
    <div id="productModal" class="modal notranslate">
        <div class="modal-content" style="max-width: 800px;">
            <span class="close-modal" onclick="closeProductModal()">×</span>
            <h2 style="margin-top: 0; border-bottom: 2px solid var(--lg-red); padding-bottom: 12px; margin-bottom: 20px;">
                제품군 선택</h2>

            <div style="display: flex; gap: 20px; height: 400px;">
                <!-- Level 2 Selection -->
                <div style="flex: 1; border: 1px solid #ddd; padding: 10px; display: flex; flex-direction: column;">
                    <h3 style="margin-top: 0; font-size: 16px; border-bottom: 1px solid #eee; padding-bottom: 5px;">대분류
                        (Product Lv2)</h3>
                    <div style="margin-bottom: 8px; padding: 6px 5px; background: #fff8e1; border: 1px solid #ffe082; border-radius: 4px;">
                        <label style="cursor: pointer; font-size: 12px; font-weight: bold; display: flex; align-items: center; gap: 6px; color: #e65100;">
                            <input type="checkbox" id="allProductCheck" onchange="toggleAllProduct(this)">
                            ★ ALL (전체 제품군)
                        </label>
                    </div>
                    <div id="lv2List" style="overflow-y: auto; flex: 1;">
                        <!-- Lv2 Checkboxes will be here -->
                    </div>
                </div>

                <!-- Level 3 Selection -->
                <div style="flex: 1; border: 1px solid #ddd; padding: 10px; display: flex; flex-direction: column;">
                    <h3 style="margin-top: 0; font-size: 16px; border-bottom: 1px solid #eee; padding-bottom: 5px;">소분류
                        (Product Lv3)</h3>
                    <div id="lv3SelectAllContainer" style="margin-bottom: 5px; display: none;">
                        <label style="cursor: pointer; font-size: 12px; font-weight: bold; display: flex; align-items: center; gap: 5px;">
                            <input type="checkbox" id="selectAllLv3" onchange="toggleSelectAllLv3(this)">
                            전체 선택
                        </label>
                    </div>
                    <div id="lv3List" style="overflow-y: auto; flex: 1;">
                        <div style="color: #999; text-align: center; margin-top: 50px;">대분류를 먼저 선택하세요.</div>
                    </div>
                </div>
            </div>

            <div style="text-align: right; margin-top: 20px;">
                <button class="btn-secondary" onclick="closeProductModal()">취소</button>
                <button class="btn-primary" onclick="confirmProductSelection()">선택 완료</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function renderLv2List() {
            ...
            productData.forEach(item => {
                if (!lv2Map.has(item.lv2)) {
                    lv2Map.set(item.lv2, item.lv2Name);
                }
            });

            lv2Map.forEach((name, code) => {
        ...
        function renderLv3List() {
            ...
            const availableLv3 = productData.filter(item => selectedLv2Codes.has(item.lv2));
            ...
            availableLv3.forEach(item => {
                ...
                div.innerHTML = `
                    <label style="cursor: pointer; display: flex; align-items: center; gap: 5px;">
                        ...
                        <span>[${item.lv2Name}] ${item.lv3Name} <span style="color: #888;">(${item.lv3})</span></span>
                    </label>
                `;
                container.appendChild(div);
            });
        ...
        function confirmProductSelection() {
            ...
            // Ensure array format for attributes
            const lv2Array = Array.from(selectedLv2Codes);
            const lv3Array = Array.from(selectedLv3Codes);

            // Format as stringified array for data attributes: "['A', 'B']"
            ...
            lv3Array.forEach(code => {
                const item = productData.find(i => i.lv3 === code);
                if (item) {
                    displayNames.push(item.lv3Name);
                } else {
            ...
            if (displayNames.length > 0) {
                ...
                lv2Array.forEach(code => {
                    const item = productData.find(i => i.lv2 === code);
                    if (item && !lv2Names.includes(item.lv2Name)) {
                        lv2Names.push(item.lv2Name);
                    }
                });
        ...
        function openModelModal() {
            ...
            selectedLv3Codes.forEach(code => {
                const item = productData.find(i => i.lv3 === code);
                if (item) lv3Names.push(item.lv3Name);
            });
        ...
        function renderModelList() {
            ...
            // Check globalModelData availability
            if (typeof globalModelData === 'undefined') {
                container.innerHTML = '<div style="text-align:center; padding: 20px;">모델 데이터를 불러오는 중이거나 찾을 수 없습니다. (model_data.js 확인)</div>';
                return;
            }

            // Filter models specific to selected Lv3
            const filteredModels = globalModelData.filter(item => {
                // Must belong to selected Lv3
            ...
            // Limit rendered items for performance if too many
            const renderLimit = 500;
            const modelsToRender = filteredModels.slice(0, renderLimit);
            ...
            if (filteredModels.length > renderLimit) {
                const msg = document.createElement('div');
                msg.style.textAlign = 'center';
                msg.style.padding = '10px';
                msg.style.color = '#888';
                msg.textContent = `${filteredModels.length - renderLimit}개의 모델이 더 있습니다. 검색어를 입력하여 좁혀보세요.`;
        ...
        function confirmModelSelection() {
            ...
            // Input field (Human readable) - Limit to 6
            ...
            // PostData attribute (Code format: "['A', 'B']")
            const postDataDiv = document.querySelector('.postData');
        ...
        function getModelSet() {
            if (!modelSet && typeof globalModelData !== 'undefined') {
                modelSet = new Set(globalModelData.map(item => item.model.toUpperCase()));
            }
            return modelSet;
        }
        ...
        function syncModelData() {
            ...
            // Removed forced toUpperCase() to allow user to type in lowercase
            ...
            // Split by comma to handle multiple models if typed manually
